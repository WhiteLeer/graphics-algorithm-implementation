...
{
    private const string Root = "Assets/MaterialFX/NPR/NPR-Core/Textures/StyleMaps";
    private const string Prefix = "TEX_NPR3";

    [MenuItem("Tools/NPR 风格/校验贴图通道规范")]
    public static void Validate()
    {
        ...
        foreach (var kv in rules)
        {
            ...
            string[] paths =
            {
                $"{Root}/{style}/{Prefix}_Face_LightMap.png",
                $"{Root}/{style}/{Prefix}_Body_LightMap.png",
                $"{Root}/{style}/{Prefix}_Hair_LightMap.png"
            };
