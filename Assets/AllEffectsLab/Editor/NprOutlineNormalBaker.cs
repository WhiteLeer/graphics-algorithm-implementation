...
{
    private const string HoudiniRoot = "Assets/MaterialFX/NPR/NPR-Core/Meshes/HoudiniBaked";
    private const string AppliedRoot = "Assets/MaterialFX/NPR/NPR-Core/Meshes/HoudiniApplied";
    private const string SourcePrefabPath = "Assets/_Prefab/Player_Girl.prefab";

    [MenuItem("Tools/NPR 风味/应用 Houdini 描边网格(选中)")]
    public static void ApplyHoudiniBakedMeshes()
    {
        ...
        EnsureFolder("Assets/MaterialFX/NPR/NPR-Core/Meshes", "HoudiniApplied");
    ...
    [MenuItem("Tools/NPR 风味/恢复原始骨骼网格(全场景)")]
    ...
    private static Mesh BuildAppliedMeshFromHoudiniNormals(Mesh src, Mesh baked, string objectName)
    {
        ...
        outMesh.name = src.name + "_HoudiniApplied";
        ...
        string fileName = SanitizeName(objectName) + "_HoudiniApplied.asset";
