Shader "Custom/NPR-1/ShadowOutlineURP"
{
    Properties
    {
        ...
        _ShadeColor("Shade Color", Color) = (0.48,0.50,0.58,1)
        ...
        _SpecThreshold("Spec Threshold", Range(0,1)) = 0.9
        ...
        [Header(Outline)]
        _OutlineColor("Outline Color", Color) = (0.08,0.10,0.14,1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings IN) : SV_Target
            {
                ...
                float3 toonRamp = lerp(_ShadeColor.rgb, 1.0.xxx, diffuseBand) * shadow;
