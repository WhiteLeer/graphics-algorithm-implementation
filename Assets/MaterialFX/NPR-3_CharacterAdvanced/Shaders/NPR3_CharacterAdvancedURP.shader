    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings IN) : SV_Target
            {
                ...
                float hairSpec = (hairPrimary + hairSecondary * _HairSpecSecondaryStrength) * _HairSpecStrength;
        ...
        Pass
        {
            ...
            Varyings VertOutline(Attributes IN)
            {
                ...
                float2 offset = normalize(normalVS.xy) * (_OutlineWidth * 0.004 * distScale * silhouetteScale);
